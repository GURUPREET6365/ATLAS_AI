...
def create_admin():
    ...
    admin = User(first_name=ADMIN_FIRST_NAME,last_name=ADMIN_LAST_NAME,email=ADMIN_EMAIL,role=ADMIN_ROLE,password=hashed_password, phone_number=ADMIN_PHONE_NUMBER, chat_id=ADMIN_CHAT_ID)
